...
include 'config/db_config.php';
    ...
    $mail->Body    = '
          <div>
          Hi!<br><br>
      <div>Your Subscription has Expired, if you wish to Resubscribe please login to your account.<br><br>
      <div>If you have any concerns please email us at <p style="text-decoration: underline; display:inline;">sesldespro@gmail.com</p><br>
      <div>Thank you for using our locker system!<br><br>
      <div> <p style="color: #959595;">Smart Electronic Storage Locker Team<p><br>
      </div></div></div></div></div>';      
    $mail->send();
